...
namespace Unity.FPS.Gameplay
{
    ...
    public class PlayerWeaponsManager : MonoBehaviour
    {
        ...
        [Tooltip("Reference to our Grappling Hook")]
        public WeaponController m_GrapplingHook;
        ...
        {
            Debug.Log("subscribe");
            m_GrapplingHook.grappleHit += GrappleHit;
            m_GrapplingHook.grappleUpdate += GrappleUpdate;
            m_GrapplingHook.grappleRelease += GrappleRelease;
            m_GrapplingHook.Owner = gameObject;
        }

        void GrappleHit(Vector3 hitPos, Transform muzzle)
        {
            m_PlayerCharacterController.StartGrapple(hitPos, muzzle);
        }

        void GrappleUpdate(Vector3 hitPos)
        {
            m_PlayerCharacterController.UpdateGrapplePoint(hitPos);
        }

        void GrappleRelease()
        {
            m_PlayerCharacterController.GrappleRelease();
        }
        ...
        void Update()
        {
            ...
            if (activeWeapon != null && m_WeaponSwitchState == WeaponSwitchState.Up)
            {
                ...
                if (grappleEnabled)
                {
                    m_GrapplingHook.HandleShootInputs(
        ...
        public bool AddWeapon(WeaponController weaponPrefab)
        {
            ...
            for (int i = 0; i < m_WeaponSlots.Length; i++)
            {
                ...
                if (m_WeaponSlots[i] == null)
                {
                    ...
                    if (weaponInstance.KnockBack)
                    {
                        weaponInstance.knockbackPlayer += m_PlayerCharacterController.ReceiveKnockback;
                    }
