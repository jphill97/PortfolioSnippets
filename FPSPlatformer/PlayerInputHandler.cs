...
namespace Unity.FPS.Gameplay
{
    public class PlayerInputHandler : MonoBehaviour
    {
        ...
        /// <summary>
        /// Returns a Vector4 representing input for W,A,S,D respectively
        /// </summary>
        /// <returns></returns>
        public Vector4 GetMoveInput()
        {
            if (CanProcessInput())
            {
                Vector4 move = new Vector4(System.Convert.ToInt32(Input.GetKey(KeyCode.W)),
